...
<img src="./images/decision_tree/信息熵公式.png" width="300" alt="信息熵式" align=center />
...
- 公式
  - 属性A对训练数据集 D 的信息增益 $g(D,A)$，定义为集合 D 的信息熵 H(D)与属性 A 给定条件下 D 的信息条件熵 H(D|A) 之差，即：
   ...
   - 公式详解
     ...
     <img src="./images/decision_tree/信息增益公式详解.png" width="300" align=center />
...
- 增益率定义
  ...
  <img src="./images/decision_tree/增益率定义.png" width="300" align=center />
...
- 数据集 D 的纯度可用基尼值来度量：
    ...
    <img src="./images/decision_tree/基尼值度量纯度.png" width="300" align=center />
